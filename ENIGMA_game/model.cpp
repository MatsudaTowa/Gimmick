...
void ExclusionCollision(void)
{
	...
	//12--ダンボール１
	g_aModel[12].Minpos = D3DXVECTOR3(-211.0f, 0.0f, -31.0f);
	g_aModel[12].Maxpos = D3DXVECTOR3(211.0f, 153.0f, 31.0f);
	g_aModel[12].bCollision = true;
	//38--ダンボール2
	g_aModel[38].Minpos = D3DXVECTOR3(-31.0f, 0.0f, -90.0f);
	g_aModel[38].Maxpos = D3DXVECTOR3(31.0f, 153.0f, 90.0f);
	g_aModel[38].bCollision = true;
	//47--ダンボール3
	g_aModel[47].Minpos = D3DXVECTOR3(-31.0f, 0.0f, -90.0f);
