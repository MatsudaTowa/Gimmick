...
//{
//	{"data\\FONT\\DokiDokiFantasia.otf", "どきどきファンタジア"},	 // タイトルBGM//-1がループ/0が一回きり
//};
...
HRESULT Init(HINSTANCE hInstance, HWND hWnd, BOOL bWindows)
{
	//----------------------------------------------------------------------------------------------------------------------------------ここから共通
	//画面全体のときのビューポート
	g_fullScreen_Viewport.X = 0.0f;//ビューポートの開始位置-X
	g_fullScreen_Viewport.Y = 0.0f;//ビューポートの開始位置-Y
...
//	char aStr[1024];
//
//	D3DXCreateFont(g_pD3DDevice, FontSize, 0, FW_HEAVY, 1,
//		FALSE,
//		DEFAULT_CHARSET,
//		OUT_TT_ONLY_PRECIS,
//		ANTIALIASED_QUALITY,
...
//
//	//文字列に代入
//	wsprintf(&aStr[0], Text);
//
//	//テキストの描画
//	g_pFont_Comment[Font]->DrawText(NULL, &aStr[0], -1, &rect, DT_LEFT, D3DCOLOR_RGBA(255, 255, 15, 255));
//
//}
//
