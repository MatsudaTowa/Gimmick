...
void SetPassword(void)
{
	...
	{//2Pの時
		...
		for (int nCntPos = 0; nCntPos < NUM_DIGIT; nCntPos++)
		{
			...
			{
			case 0:
				g_aPassword[nCntPos].pos = D3DXVECTOR3(PASSWORD_FIRSTPOS_2P, (SCREEN_HEIGHT / 1.25f), 0.0f);
				break;
			case 1:
				g_aPassword[nCntPos].pos = D3DXVECTOR3(PASSWORD_FIRSTPOS_2P + PASSWORD_ADDPOS, (SCREEN_HEIGHT / 1.25f), 0.0f);
				break;
			case 2:
				g_aPassword[nCntPos].pos = D3DXVECTOR3(PASSWORD_FIRSTPOS_2P + PASSWORD_ADDPOS * nCntPos, (SCREEN_HEIGHT / 1.25f), 0.0f);
				break;
			case 3:
				g_aPassword[nCntPos].pos = D3DXVECTOR3(PASSWORD_FIRSTPOS_2P + PASSWORD_ADDPOS * nCntPos, (SCREEN_HEIGHT / 1.25f), 0.0f);
				break;
